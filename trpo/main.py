...
if __name__ == '__main__':
    ...
    logdir = "./logs/alg_trpo/env_{}".format(alg_args.env_name)
    file_name = 'alg_trpo_env_{}_batch{}_seed{}_time{}.csv'.format(alg_args.env_name, alg_args.batch_size, alg_args.seed, time())
